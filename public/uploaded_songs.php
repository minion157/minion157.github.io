<?php
	...
	if(isset($_POST['upload'])){
		...
		$sql="CALL uploadsongs('$artist_id','$song_name','$song_format','$artist_name','$song_image','$audio_file')";

		$sql = "INSERT INTO upload_albums(`artist_id`,`song_name`,`song_format`,`artist_name`,`song_image`,`audio_file`) VALUES('$artist_id','$song_name','$song_format','$artist_name','$song_image','$audio_file')";
		$result = mysqli_query($conn,$sql);
		if($result){
	...
	while($rows = mysqli_fetch_array($result)){
		...
		if(isset($_POST[$song_id])){
			...
			$sql = "SELECT * FROM favorite_songs WHERE song_id = '$song_id' AND gen_id = '0' AND user_id = '$user_id' ";
			...
			$sql = "INSERT INTO favorite_songs(`gen_id`,`song_id`,`user_id`,`song_name`,`artist_name`,`song_image`,`audio_file`) VALUES('0','$song_id','$user_id','$song_name','$artist_name','$song_image','$audio_file') ";
			$results = mysqli_query($conn,$sql);
...
<head>
	<title>Cadenza | Uploaded Songs</title>
...
<form method="post" action="uploaded_songs.php" enctype="multipart/form-data" id="upload-form">
	<div class="form-row">
		<div class="col">
...
<center><b><div class="alert alert-primary" role="alert">
  Most featured songs...<a href="#" class="alert-link">Listen to music </a>. And have fun.
	...
	<div class="cpy-right text-center">
		<p>© 2018 Cadenza. All rights reserved</p>
	</div>
    <!-- //copyright -->
    <!-- js-->
