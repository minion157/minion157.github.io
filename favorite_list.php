...
<body>
					...
					echo "
							<div class='col-md-3'>
								<form method='post' action='favorite_list.php'>
									<div class='card-deck'>
										<div class='card-img'>
											<img src='songs/favorite_list/img/musical-world.jpg' style='width:350px;height:250px;'alt=''>
										</div>
										<div class='card-desc'>
	...
	<div class="contact-top text-center" id="more_info">
		<div class="content-contact-top">
			<h3 class="stat-title text-white">Cadenza Music</h3>
			<h2 class="stat-title text-white">stay in touch</h2>
			<p class="text-white w-75 mx-auto">Cadenza a unique platform for aspiring singers.
			</p>
		</div>
	</div>
	<!-- //contact top -->
